              ...
              <div className='mx-auto max-w-9xl px-2 sm:px-2 lg:px-4'>
                <div className='relative'>
                  <div className='flex items-center justify-end py-2 h-16 space-x-3'>
                    <ModeToggler
                      icon={<IconType icon={activeMode ? faMoon : faSun} className='h-6' />}
                      active={activeMode}
                      setTheme={setTheme}
                      activate={activateTheme}
                      className={
                        'h-10 w-10 dark:bg-gray-700 flex items-center justify-center ring-2 dark:ring-gray-700/50 dark:text-white text-gray-900 shadow-md rounded-md'
                      }
                    />
                  ...
                  <div className='relative flex items-center justify-between py-2 h-28'>
                    ...
                    <div className='flex items-center space-x-5 mr-20 sm:mr-0'>
                      <UserIcon className='text-gray-800 h-10 w-10' />
