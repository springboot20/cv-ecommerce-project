...
export default function StatusSwitch({
  ...
  return (
    <Switch
      ...
      className={clx(
        enabled ? bgClass : "bg-gray-200 border",
        "group relative flex h-6 w-12 cursor-pointer rounded-full transition-colors duration-200 ease-in-out focus:outline-none",
      )}
    >
      <span
        aria-hidden="true"
