...
export default function Overview() {
  ...
  return (
    <Fragment>
      ...
      <div className="max-w-7xl mx-auto mt-4 grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div className="bg-white rounded-lg p-4 col-span-1 lg:col-span-2 w-full border">
          <OrderCountsChart />
        </div>
        <div className="bg-white rounded-lg p-4 col-span-1 border">
          <PieOverview />
        </div>
      </div>
