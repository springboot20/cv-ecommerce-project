...
export const OrderSummary: React.FC = () => {
  ...
  return (
    <div className='relative w-full flex-col lg:col-span-1'>
      <h3 className='text-base sm:text-lg font- text-gray-600 capitalize'>order summary</h3>
        ...
        {!cart?.items?.length ? (
          <div className='p-4'>
            ...
            <div className='flex items-center justify-center'>
              <Link
                to='/collections'
                className='bg-gray-800 hover:bg-gray-600 rounded-md px-3 py-1 text-sm font-normal text-white shadow-sm focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-gray-600'>
                Keep Shopping
              </Link>
            </div>
          </div>
