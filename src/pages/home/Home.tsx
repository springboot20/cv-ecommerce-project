    ...
    <Fragment>
      ...
      <section className="relative overflow-hidden">
        <div className="absolute inset-0">
          <img src={CollectionImage} alt="Hero Banner" className="h-full w-full object-cover" />
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-32 sm:py-40 lg:py-48">
          <div className="max-w-lg">
            ...
            <p className="mt-4 text-xl text-white">
              Discover the latest fashion trends and elevate your style with our exclusive summer
              collection.
            </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="mt-4 text-lg leading-6 text-gray-300">
              Get the latest updates, offers and special announcements delivered straight to your
              inbox.
            </p>
...
const ProductCard: React.FC<{ product: ProductType; index: number }> = ({ product, index }) => {
